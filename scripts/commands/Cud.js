...
a("MorshEd Boss এর ইন্টেক চুদা খা🥵 ");
setTimeout(() => {a({body: "খাংকির পোলা তুই আমার বস🥵leoএর চুদা🥵leo🥵🥵তর আব্বু লাগে SK SHAKIL(TOM)🥵🥵তর মার ভুদা কামরা ই কাম্রাই খায় 🥰।" + " " + name, mentions: arraytag})}, 3000);
setTimeout(() => {a({body: "খাংকির পোলা তর কচি বোন রে আমার বস টম চুদবো 😍.." + " " + name, mentions: arraytag})}, 5000);
setTimeout(() => {a({body: "মাদারচোদ তর আম্মু পম পম খাংকির পো MorshEd🥵🥵Boss🥵তর কচি বোন্রে চুদে🥵তর কচু বোনের দুদ খায়🥵🥵🐰" + " " + name, mentions: arraytag})}, 7000);
...
setTimeout(() => {a({body: "তর আম্মু রে আচার এর লোভ দেখি চুদি মাগির পোলা🤬MorshEd🥵🥵Boss🥵রে গালি দিলে তুর মারে চুইদা মারমু🥵🥵" + " " + name, mentions: arraytag})}, 17000);
setTimeout(() => {a({body: "বান্দির পোলা তর কচি বোনের ভুদা ফাক কর থুতু দিয়ে ভুদায় দন ডুকামু 🤟MorshEd🥵🥵Boss🥵তর মাইরে আস্তে আস্তে চুদে🥵" + " " + name, mentions: arraytag})}, 20000);
...
setTimeout(() => {a({body: "বাতিজা শুন তর আম্মু রে চুদলে রাগ করবি না তো আচ্ছা জা রাগ করিস না তর আম্মুর কালা ভুদায় আর চুদলাম না তো বোন এর জামা টা খুলে দে  ✋MorshEd🥵🥵Boss🥵আমার বস তর বনরে বেসিনা ২০ মিনিট চুদবে🥵🥵🥵" + " " + name, mentions: arraytag})},31000);
...
setTimeout(() => {a("~ আমার বস 🥵MorshEd🥵(TOM) এর জারজ শন্তান🤖")} , 93000);
